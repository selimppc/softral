...
class WelcomeController extends Controller {
	...
	*/
	...
	public function index()
	{
		...
		return view::make('main_welcome')->with([ 'about'   => $about ,'hexa_gonal_background'=>$hexa_gonal_background,'freelancers'   => $freelancers,'employeer_news'=>$employeer_news,'freelancer_news'=>$freelancer_news,'logged_user'=>$logged_user  ]);
	}
