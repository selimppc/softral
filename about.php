                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="vid ">
                                    <div class="videos_box">
                                        <div class="videos">
                                            <video class="video stopvideo box-shadow-4 bg_white padding-5-5" style="max-height:270px;" controls width="100%" poster="http://www.softral.com/images/Screenshot_2.png">
                            ...
                            <div class="col-md-6 ">
                                <div class="vid ">
                                    <div class="videos_box">
                                        <div class="videos">
                                            <video class="video stopvideo box-shadow-4 bg_white padding-5-5" style="max-height:270px;" controls width="100%" poster="http://www.softral.com/images/Screenshot_3.png">
                                                <source src="http://www.softral.com/uploads/video/sofware 2.mp4" type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                            <div class="playpause" style="display: none;"></div>
