                		...
                		<tbody>
                            ...
                            <tr style="line-height:0">
                        		<td style="line-height:0;background-color:#fff;vertical-align:middle;" width="425" height="83" valign="top">
                                	<p style="font-family:Helvetica,Arial,sans-serif;font-size:25px;color:#333;margin:0;padding:0;line-height:45px;	 		 									font-weight:bold;text-align:center;">New job notification from Softral</p>
                        		</td>
                        	</tr>
                       	</tbody>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="37" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#333333;margin:0;padding:0;line-height:14px;font-weight:bold;margin-bottom:0">Hi {!! ucfirst($user) !!}, You have got new job notification</p></td>
