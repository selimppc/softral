       ...
       @if($errors->any())
		...
		@endif
			...
			<div class="form-group">
					...
					{!! Form::select('job_type', array('fixed'=>'Fixed Price','hourly'=>'Hourly Price'),null, ['class' => 'form-control job_type','style'=>'width:45%;display:inline']) !!}
			</div>
				...
				<div class='row hourly' style='<?php echo $style1;?>'>
					<div class='col-lg-6'>
						<div class="form-group" >
							...
							<span style="" class="usd">US $</span>
							{!! Form::text('hourperweek', null, ['class' => 'form-control','placeholder'=>'hours/week','style'=>'width:45%;display:inline']) !!}
						</div>
					</div>
			...
			@else
				{!! Form::submit('Submit', ['class' => 'btn btn-primary disabled','data-toggle'=>"tooltip",'title'=>"Please submit your financial info before posting a job.",]) !!}
			@endif
